...
{
    class ModuleKPBSNuclearStorage : PartModule
    {
        //-------------------------Public settings------------------------
        ...
        [KSPField(guiActive = true, guiName = "#LOC_KPBS.nuclearfuel.transferstate")]
        ...
        /// </summary>
        [KSPEvent(guiName = "#LOC_KPBS.nuclearfuel.fuel.transfer", guiActive = true, guiActiveUnfocused = false, unfocusedRange = 5f, guiActiveEditor = false)]
        public void initTransferFuel()
        {
            if (!checkCrew(minLevelFuelTransfer))
            {
                ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.skill", minLevelFuelTransfer, neededSkill, PartResourceLibrary.Instance.GetDefinition(fuelResource).displayName), 2f, ScreenMessageStyle.UPPER_CENTER));
            }
            else if (!isSave())
            {
                ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.running"), 2f, ScreenMessageStyle.UPPER_CENTER));
            }
            else if (!hasResource(fuelResource))
            {
                ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.noFuel", PartResourceLibrary.Instance.GetDefinition(fuelResource).displayName), 2f, ScreenMessageStyle.UPPER_CENTER));
            }
            else
            {
                ...
                {
                    ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.noTarget", PartResourceLibrary.Instance.GetDefinition(fuelResource).displayName), 2f, ScreenMessageStyle.UPPER_CENTER));
                }
            }
        ...
        public void initTransferWaste()
        {
            ...
            {
                ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.skill", minLevelWasteTransfer, neededSkill, PartResourceLibrary.Instance.GetDefinition(wasteResource).displayName), 2f, ScreenMessageStyle.UPPER_CENTER));
            }
            else if (!isSave())
            {
                ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.running"), 2f, ScreenMessageStyle.UPPER_CENTER));
            ...
            {
                ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.noFuel", PartResourceLibrary.Instance.GetDefinition(wasteResource).displayName), 2f, ScreenMessageStyle.UPPER_CENTER));
            }
            else
            {
                ...
                if ((transferCandidates != null) && (transferCandidates.Count > 0))
                {
                    ...
                    status = Localizer.Format("#LOC_KPBS.nuclearfuel.status.selecting", PartResourceLibrary.Instance.GetDefinition(wasteResource).displayName);
                    nextTarget();
                    updateUI();
                }
                else
                {
                    ScreenMessages.PostScreenMessage(new ScreenMessage(Localizer.Format("#LOC_KPBS.nuclearfuel.error.noTarget", PartResourceLibrary.Instance.GetDefinition(wasteResource).displayName), 2f, ScreenMessageStyle.UPPER_CENTER));
                }
            }
        }
        ...
        /// </summary>
        [KSPEvent(guiName = "#LOC_KPBS.nuclearfuel.target.next", guiActive = true, guiActiveUnfocused = false, unfocusedRange = 5f, guiActiveEditor = false)]
        ...
        /// </summary>
        [KSPEvent(guiName = "#LOC_KPBS.nuclearfuel.target.prev", guiActive = true, guiActiveUnfocused = false, unfocusedRange = 5f, guiActiveEditor = false)]
        ...
        /// </summary>
        [KSPEvent(guiName = "#LOC_KPBS.nuclearfuel.startTransfer", guiActive = true, guiActiveUnfocused = false, unfocusedRange = 5f, guiActiveEditor = false)]
        ...
        /// </summary>
        [KSPEvent(guiName = "#LOC_KPBS.nuclearfuel.stopTransfer", guiActive = true, guiActiveUnfocused = false, unfocusedRange = 5f, guiActiveEditor = false)]
        ...
        /// </summary>
        [KSPEvent(guiName = "#LOC_KPBS.nuclearfuel.cancelTransfer", guiActive = true, guiActiveUnfocused = false, unfocusedRange = 5f, guiActiveEditor = false)]
        ...
        public override void OnStart(StartState state)
        {
            ...
            //
            Events["initTransferFuel"].guiName = Localizer.Format("#LOC_KPBS.nuclearfuel.fuel.transfer", PartResourceLibrary.Instance.GetDefinition(fuelResource).displayName);
            Events["initTransferWaste"].guiName = Localizer.Format("#LOC_KPBS.nuclearfuel.fuel.transfer", PartResourceLibrary.Instance.GetDefinition(wasteResource).displayName);
